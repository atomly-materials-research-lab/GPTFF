...
class ThreeBodyEdgeDelta(nn.Module):
    def __init__(self, atom_fea_len, nbr_fea_len, num_radial, num_angular, dropout=0.0):
        super().__init__()
        self.atom_fea_len = atom_fea_len
        self.nbr_fea_len = nbr_fea_len
...
class InteractionBlock(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.atom_update = AtomFeatureDelta(atom_fea_len, nbr_fea_len, num_radial, dropout=dropout)
